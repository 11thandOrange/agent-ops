...
Reference example for a `type: dev` project skill — written by hand as the pilot; later app skills are generated by `project-scaffold` and should follow this same shape.
