// Real auth on every inbound endpoint from day one (roadmap Phase 2, step 3;
// strategy doc §9.1) — /trigger and /webhook/mcp check a shared secret header,
// /webhook/github verifies GitHub's HMAC webhook signature instead, since
// that's the mechanism GitHub itself provides.
